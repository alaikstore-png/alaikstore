...
import { User, Wallet, Clock, Heart, Users, Ticket, Copy, Trash2, Loader2, Share2, PiggyBank } from 'lucide-react'
...
export default function DashboardUser() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-6 pt-24 pb-16">
      <h1 className="font-display text-2xl font-bold mb-8">Dashboard Saya</h1>
